...
>> Согласен. Здесь inline нужно не для встраивания, а для обмана тупых компиляторов.
...
>> ОК. Хотя общепринятой практикой все же считается использование беззнаковых типов для представления размеров.
