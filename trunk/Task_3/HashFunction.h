...
/*=* CLang ругается на необъявленный класс unary_function.
 * Нужно обязательно включать заголовочные файлы, которые указаны в reference,
 * а не надеяться, что они будут где-то включены неявно. */
#include <functional>
